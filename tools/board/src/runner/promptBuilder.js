...
7. Set the appropriate agent in the card's frontmatter (infra, server, client, assets, or audio). If the work does not fit any specific subsystem, set agent to \`generic\` instead.
8. Validate the card still parses: run \`node tools/board/scripts/validateBacklog.js\` if you have Bash access.
9. Commit your changes with a one-line summary of what you expanded, then stop.
