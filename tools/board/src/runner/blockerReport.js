 ...
 */
export function buildBlockerReport({ task, attemptRecords, attemptCount }) {
  ...
  return { attempted, failureSignature, lacks: { category, detail } };
}
...
export function formatBlockerReportComment(report) {
  ...
  return [
    "## Blocker report (auto-retry exhausted)",
    "",
