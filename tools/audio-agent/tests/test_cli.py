"""CLI entrypoint: `audio-agent generate ...` -- what the `audio` agent (or a
human, per the manual live-smoke instructions in README.md) actually
invokes. Mocks `pipeline.generate`, no real ACE-Step/HTTP here. Mirrors
tools/comfy-client/tests/test_cli.py."""
...
from audio_agent.provenance import build_provenance_record
