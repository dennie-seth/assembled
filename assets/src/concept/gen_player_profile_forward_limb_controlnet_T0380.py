...
POSITIVE_PROMPT = (
    ...
    "close to the body and hidden from view, "
    "(the far hand and far wrist fully concealed inside the coat sleeve, completely out of "
    "sight, no far hand visible anywhere, nothing resting at the hip or waist:1.3), "
    "one visible shoulder, a single visible arm "
    ...
    "coat and a different colour from the green coat, fingers visible:1.2), wearing a long "
    "vivid institutional green cloth coat, coat "
...
NEGATIVE_PROMPT = (
    ...
    "hands visible, two hands visible, second hand visible, far hand visible, hand at the hip, "
    "fist at the hip, hand resting on the hip, hand at the waist, fist at the waist, second "
    "glove, glove at the hip, extra hand, extra limb, both eyes visible, both eye lenses "
    "visible, two eye lenses, second lens, far eye visible, both shoulders visible, symmetric "
    "front-facing pose, "
