#!/usr/bin/env python3
"""Render Arm C's delivered sheet as a judgeable, in-motion preview (T-0230).

Mirrors render_judging_preview_arm_b_T0229.py -- DL-21 judges every bake-off
arm "at 40px, in motion, inside the T-0192 blockout room", explicitly not at
...
Usage (from the repo root):
    python3 assets/src/character/render_judging_preview_arm_c_T0230.py

Reads:
    assets/final/character/player_idle_sheet_arm_c_T0230.png
Writes:
    assets/final/character/arm_c_judging_preview_T0230.gif
"""
...
OUT_PATH = REPO_ROOT / "assets" / "final" / "character" / "arm_c_judging_preview_T0230.gif"
