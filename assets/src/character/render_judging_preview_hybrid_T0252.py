#!/usr/bin/env python3
"""Render the hybrid sheet as a judgeable, in-motion preview (T-0252).

Mirrors render_judging_preview_arm_c_T0230.py -- DL-21 judges every round
...
has no committed screenshot of the blockout room, so this composites onto a
flat mockup at the room's own committed pixel dimensions (384x216, DL-18)
instead of an actual in-engine capture.

Usage (from the repo root):
    python3 assets/src/character/render_judging_preview_hybrid_T0252.py

Reads:
    assets/final/character/player_idle_sheet_hybrid_T0252.png
Writes:
    assets/final/character/hybrid_judging_preview_T0252.gif
"""
...
SHEET_PATH = REPO_ROOT / "assets" / "final" / "character" / "player_idle_sheet_hybrid_T0252.png"
OUT_PATH = REPO_ROOT / "assets" / "final" / "character" / "hybrid_judging_preview_T0252.gif"
