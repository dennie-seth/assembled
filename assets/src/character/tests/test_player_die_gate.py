"""Player die sheet — T-0199 gate validation.
...
Sheet: player_die_sheet_v1.png (9 death-sequence frames, 0 spare cells).
...
def sheet() -> Image.Image:
    assert SHEET_PATH.exists(), (
        f"die sheet not found: {SHEET_PATH}\n"
        "Run `generate-synth-die-sheet` to produce it."
    )
