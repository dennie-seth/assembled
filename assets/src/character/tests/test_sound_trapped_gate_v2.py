"""Sound entity trapped sheet v2 — T-0214 gate validation.

Concept-conditioned re-run of T-0200 sound trapped sheet, conditioned on the
...
Sheet: assets/final/entity/sound_trapped_sheet_v2.png (4 trapped/delayed frames).
...
SHEET_PATH = REPO_ROOT / "assets" / "final" / "entity" / "sound_trapped_sheet_v2.png"
PROV_PATH = REPO_ROOT / "assets" / "final" / "entity" / "sound_trapped_sheet_v2.provenance.json"
...
def sheet() -> Image.Image:
    assert SHEET_PATH.exists(), (
        f"sound trapped sheet v2 not found: {SHEET_PATH}\n"
