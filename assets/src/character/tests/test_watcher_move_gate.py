"""Watcher entity move sheet — T-0200 gate validation.

docs/design/13-asset-pipeline.md §3.5 (Characters — the hard class):
  cell 48×48, grid 4×2, native 192×96, entity figure ~20px tall.

Sheet: assets/final/entity/watcher_move_sheet_v1.png (8 move frames).

Watcher: surveillance orb entity — horizontal drift animation.

RED state:  assets/final/entity/watcher_move_sheet_v1.png absent
...
SHEET_PATH = REPO_ROOT / "assets" / "final" / "entity" / "watcher_move_sheet_v1.png"
...
def sheet() -> Image.Image:
    assert SHEET_PATH.exists(), (
        f"watcher move sheet not found: {SHEET_PATH}\n"
        "Run `generate-synth-watcher-move-sheet` to produce it."
    )
