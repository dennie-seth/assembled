"""Still Air entity idle sheet — T-0200 gate validation.

docs/design/13-asset-pipeline.md §3.5 (Characters — the hard class):
  cell 48×48, grid 3×2, native 144×96, entity figure ~32px tall (narrow column).

Sheet: assets/final/entity/still_air_idle_sheet_v1.png (6 idle frames).

Still Air: atmospheric column entity — tall, narrow, ethereal. No die state.

RED state:  assets/final/entity/still_air_idle_sheet_v1.png absent
...
SHEET_PATH = REPO_ROOT / "assets" / "final" / "entity" / "still_air_idle_sheet_v1.png"
...
def sheet() -> Image.Image:
    assert SHEET_PATH.exists(), (
        f"still_air idle sheet not found: {SHEET_PATH}\n"
        "Run `generate-synth-still-air-idle-sheet` to produce it."
    )
