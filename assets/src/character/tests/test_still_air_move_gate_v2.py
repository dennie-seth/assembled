"""Still Air entity move sheet v2 — T-0214 gate validation.

Concept-conditioned re-run of T-0200 still air move sheet, conditioned on the
...
Sheet: assets/final/entity/still_air_move_sheet_v2.png (8 move frames).
...
SHEET_PATH = REPO_ROOT / "assets" / "final" / "entity" / "still_air_move_sheet_v2.png"
PROV_PATH = REPO_ROOT / "assets" / "final" / "entity" / "still_air_move_sheet_v2.provenance.json"
...
def sheet() -> Image.Image:
    assert SHEET_PATH.exists(), (
        f"still air move sheet v2 not found: {SHEET_PATH}\n"
