"""Watcher entity move sheet v2 — T-0214 gate validation.

Concept-conditioned re-run of T-0200 watcher move sheet, conditioned on the
...
Sheet: assets/final/entity/watcher_move_sheet_v2.png (8 move frames).

RED state:  watcher_move_sheet_v2.png absent → fixture raises AssertionError.
GREEN state: sheet present, mode P, 192×96; passes all gate checks,
...
SHEET_PATH = REPO_ROOT / "assets" / "final" / "entity" / "watcher_move_sheet_v2.png"
PROV_PATH = REPO_ROOT / "assets" / "final" / "entity" / "watcher_move_sheet_v2.provenance.json"
...
def sheet() -> Image.Image:
    assert SHEET_PATH.exists(), (
        f"watcher move sheet v2 not found: {SHEET_PATH}\n"
