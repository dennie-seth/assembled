"""Sound entity move sheet — T-0200 gate validation.

docs/design/13-asset-pipeline.md §3.5 (Characters — the hard class):
  cell 48×48, grid 4×2, native 192×96, entity figure ~12px tall (wide, flat).

Sheet: assets/final/entity/sound_move_sheet_v1.png (8 move frames).

Sound: wave-form entity — horizontal drift/ripple animation.

RED state:  assets/final/entity/sound_move_sheet_v1.png absent
...
SHEET_PATH = REPO_ROOT / "assets" / "final" / "entity" / "sound_move_sheet_v1.png"
...
def sheet() -> Image.Image:
    assert SHEET_PATH.exists(), (
        f"sound move sheet not found: {SHEET_PATH}\n"
        "Run `generate-synth-sound-move-sheet` to produce it."
    )
