"""Sound entity idle sheet — T-0200 gate validation.

docs/design/13-asset-pipeline.md §3.5 (Characters — the hard class):
  cell 48×48, grid 3×2, native 144×96, entity figure ~12px tall (wide, flat).

Sheet: assets/final/entity/sound_idle_sheet_v1.png (6 idle frames).

Sound: wave-form entity — wide, flat, horizontal. No die state.

RED state:  assets/final/entity/sound_idle_sheet_v1.png absent
...
SHEET_PATH = REPO_ROOT / "assets" / "final" / "entity" / "sound_idle_sheet_v1.png"
...
def sheet() -> Image.Image:
    assert SHEET_PATH.exists(), (
        f"sound idle sheet not found: {SHEET_PATH}\n"
        "Run `generate-synth-sound-idle-sheet` to produce it."
    )
