...
SHEET_PATH = REPO_ROOT / "assets" / "final" / "entity" / "watcher_idle_sheet_v1.png"
...
def sheet() -> Image.Image:
    assert SHEET_PATH.exists(), (
        f"watcher idle sheet not found: {SHEET_PATH}\n"
        "Run `generate-synth-watcher-idle-sheet` to produce it."
    )
