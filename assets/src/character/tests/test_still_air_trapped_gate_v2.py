"""Still Air entity trapped sheet v2 — T-0214 gate validation.

Concept-conditioned re-run of T-0200 still air trapped sheet, conditioned on the
T-0210 entities concept sheet (IP-Adapter/img2img via ComfyUI).

docs/design/13-asset-pipeline.md §3.5:
  cell 48×48, grid 2×2, native 96×96.

Sheet: assets/final/entity/still_air_trapped_sheet_v2.png (4 trapped/delayed frames).
...
SHEET_PATH = REPO_ROOT / "assets" / "final" / "entity" / "still_air_trapped_sheet_v2.png"
PROV_PATH = REPO_ROOT / "assets" / "final" / "entity" / "still_air_trapped_sheet_v2.provenance.json"
...
def sheet() -> Image.Image:
    assert SHEET_PATH.exists(), (
        f"still air trapped sheet v2 not found: {SHEET_PATH}\n"
